...
public class Page7Controller implements Initializable {
    ...
    private Scene scene;
    private Parent root;
    private String path= "/home/host/Documents/Project/Scholz/nikto_log.txt";
    private String ip="";
    ...
    public void start() {
        ...
        if(PortChecker.isValidPortNumber(port)) {
            ...
            try
            {
                ...
                Process pr = Runtime.getRuntime().exec("nikto -h "+ip+":"+port+"");
                pr.waitFor();
                ...
                Main.stage.close();
                Runtime.getRuntime().exec("gedit /home/host/Documents/Project/Scholz/nikto_log.txt");
            }
            catch (Exception e)
            {
